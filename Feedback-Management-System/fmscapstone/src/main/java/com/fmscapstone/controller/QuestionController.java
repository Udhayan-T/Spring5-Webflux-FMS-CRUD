...
public class QuestionController {
	...
	public Flux<QuestionsDTO> getAllQuestionsByFeedbackType(@PathVariable String feedbackType) throws InterruptedException, ExecutionException{
		return feedbackServiceImpl.getAllQuestionsByFeedbackType(feedbackType);
